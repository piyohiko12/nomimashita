...
import { largeDate, verticalMedicines } from './medicine-view.js';
    ...
    function render(){
      ...
      $('heading').innerHTML='<div class="heading-copy"><div class="brand-lockup"><img class="brand-mark" src="./brand-mark.svg" alt=""><span class="brand-name">お薬記録</span></div>'+(demo?'<span class="demo-badge">体験モード</span>':'')+(atHome?'':'<h1>'+title+'</h1>')+'</div><div class="header-actions">'+decoration(theme)+(atHome?'<button class="settings-shortcut" data-tab="settings" aria-label="設定を開く"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="m9 3 1-1h4l1 3 3 1 2-1 2 4-2 2v3l2 2-2 4-3-1-2 1-1 2h-4l-1-2-3-1-2 1-2-4 2-2v-3L2 9l2-4 3 1Z"/><circle cx="12" cy="12" r="3"/></svg></button>':'')+'</div>';
